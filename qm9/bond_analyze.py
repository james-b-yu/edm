...
def get_bond_order(atom1, atom2, distance, check_exists=False):
    ...
    if atom1 in {'H', 'C', 'N', 'O', 'F'}:
        atom1 = atom1
    else:
        atom1 = atomic_num_to_letters.get(atom1, None)
    if atom2 in {'H', 'C', 'N', 'O', 'F'}:
        atom2 = atom2
    else:
        atom2 = atomic_num_to_letters.get(atom2, None)
            ...
            if distance < thr_bond2:
                if atom1 in bonds3 and atom2 in bonds3[atom1]:
                    ...
                    if distance < thr_bond3:
                        # print(f"predicted triple bond as threshold: {thr_bond3} and actual distance: {distance}")
                        return 3        # Triple
                return 2            # Double
        return 1                # Single
    return 0                    # No bond
