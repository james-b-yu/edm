...
class QM9Dataset(EDMDataset):
    def __init__(self, use_h: bool, split: Literal["train", "valid", "test"]):
        super().__init__(num_atom_types=QM9["num_atom_types"] if use_h else QM9_NO_H["num_atom_types"], max_nodes=QM9["largest_molecule_size"] if use_h else QM9_NO_H["largest_molecule_size"], size_histogram=QM9["molecule_size_histogram"] if use_h else QM9_NO_H["molecule_size_histogram"])
